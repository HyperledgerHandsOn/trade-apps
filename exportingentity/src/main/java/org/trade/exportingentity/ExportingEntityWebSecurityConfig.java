...
public class ExportingEntityWebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		httpSecurity.csrf().disable()
			...
			.antMatchers("/acceptTrade", "/requestEL", "/prepareShipment", "/getTrade", "/getTradeStatus", "/getLC", "/getLCStatus", "/getEL", "/getELStatus", 
						"/getShipmentLocation", "/getBillOfLading", "/getAccountBalance", "/listTrades").hasRole(SecurityUtils.clientRole)
