...
public class FabricNetworkUtils {
    ...
    public static String exportingEntityOrgMsp = "ExportingEntityOrgMSP";
    ...
    public static String lcContractId = "letterOfCredit";
    public static String elContractId = "exportLicense";
    public static String shipmentContractId = "shipment";
    ...
    public static String invokeContract(String userId, String channelName, String contractId, boolean isQuery, String func, String ...args) {
        ...
        Network network = getNetworkForOrgAndChannel(connectionProfileJson, exportingEntityOrgMsp, userId, channelName);
